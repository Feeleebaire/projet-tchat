...
$('#form').keyup(function(){
    var userok = document.getElementById('info').textContent;
    //console.log("user",userok);
    var email = document.getElementById('info2').textContent;
    //console.log("email",email);
    var mdp = document.getElementById('mdpinfo').textContent;
    //console.log("mdp",mdp);
    var mdp2 = document.getElementById('mdperror').textContent;
    //console.log("mdp2",mdp2)
    var sub = document.getElementById('submit');
    if(userok == "" && email == "" && mdp == "" && mdp2 == ""){
        sub.disabled = true;
    }
    else if(userok == "ok" && email == "ok" && mdp == "ok" && mdp2 == "ok"){
        sub.disabled = false;
    }
    else {
        sub.disabled = true;
